import { pgTable, uuid, text, timestamp, varchar, index, jsonb, primaryKey } from 'drizzle-orm/pg-core';
import { projectStatusEnum, projectRoleEnum, hotspotStatusEnum } from './enums';
